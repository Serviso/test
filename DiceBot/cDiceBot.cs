...
namespace DiceBot
{
    ...
    public partial class cDiceBot : Form
    {
        ...
        public const string vers = "3.4.10.1";
...
function dobet()
            ...
            foreach (string s in NitroDice.sCurrencies)
            {
                ...
                nitrodiceToolStripMenuItem.DropDown.Items.Add(tmpItem);
                tmpItem.Click += btcToolStripMenuItem_Click;

                tmpItem.CheckedChanged += btcToolStripMenuItem_CheckedChanged;

            }
            foreach (string s in Stake.sCurrencies)
            {
                ToolStripMenuItem tmpItem = new ToolStripMenuItem { Text = s };
                ...
                stakeToolStripMenuItem.DropDown.Items.Add(tmpItem);
                tmpItem.Click += btcToolStripMenuItem_Click;
      ...
      private void Reset()
        ...
        void Tip(decimal Amount, string Address)
        {
            ...
            {
                if (CurrentSite.Tip)
                    if (CurrentSite.SendTip(Address, Amount))
                    {
    ...
    void setInterval(System.Windows.Forms.Timer tmr, int Interval)
    {
        ...
        void save()
        {
           ...
           // if (programmerToolStripMenuItem.Checked)  check hasil test srv
           // {
           //     try
           //     {
           //         File.WriteAllText("wins.dll", richTextBox3.Text);
           //     }
           //     catch (Exception e)
           //     {
           //         DumpLog(e.Message, 1);
            ...
            try
            {
                using (StreamReader sr = new StreamReader(Environment.GetEnvironmentVariable("APPDATA") + "\\DiceBot2\\Psettings"))
                {
                    ...
                    else
                    {
                        ...
                        if (File.Exists("TempCodeBackup.txt"))
                        {
                            richTextBox3.Text = File.ReadAllText("TempCodeBackup.txt");
                        }
                    }
                    ...
                    else if (Key =="Currency")
                    {
                        foreach (ToolStripMenuItem x in siteToolStripMenuItem.DropDown.Items)
                        {
                            if (x != null)
                            {
                                if (x.Checked)
                                {
                                    if (x.DropDown != null && x.DropDown.Items.Count > 0)
                                    {
        ...
        private void manualBettingToolStripMenuItem_Click(object sender, EventArgs e)
        {
